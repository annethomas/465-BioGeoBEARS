...
if(!exists("trfn")|!exists("genus")){
  ...
  # Loads to "restable"
  save(restable, file= paste0(genus,"_restable_v1.Rdata"))
  load(file=paste0(genus,"_restable_v1.Rdata"))
  
  # Loads to "teststable"
  save(teststable, file= paste0(genus,"_teststable_v1.Rdata"))
  load(file= paste0(genus,"_teststable_v1.Rdata"))
  
  # Also save to text files
  write.table(restable, file= paste0(genus,"_restable.txt"), quote=FALSE, sep="\t")
  write.table(unlist_df(teststable), file= paste0(genus,"_teststable.txt"), quote=FALSE, sep="\t")
  ...
  # Also save to text files
  write.table(restable_AIC_rellike, file= paste0(genus,"_restable_AIC_rellike.txt"), quote=FALSE, sep="\t")
  write.table(restable_AICc_rellike, file= paste0(genus,"_restable_AICc_rellike.txt"), quote=FALSE, sep="\t")
  
  # Save with nice conditional formatting
  write.table(conditional_format_table(restable_AIC_rellike), file= paste0(genus,"_restable_AIC_rellike_formatted.txt"), quote=FALSE, sep="\t")
  write.table(conditional_format_table(restable_AICc_rellike), file= paste0(genus,"_restable_AICc_rellike_formatted.txt"), quote=FALSE, sep="\t")
